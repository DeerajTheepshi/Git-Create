...
driver = webdriver.Firefox(firefox_options=options, executable_path = os.path.abspath(file_name))

driver.get("https://github.com/login")

login_box = driver.find_element_by_id("login_field")
print("Logging in using credentials.......")
login_box.send_keys("theepshi123@gmail.com")
passwd_box = driver.find_element_by_id("password")
passwd_box.send_keys("diprivi@15")
